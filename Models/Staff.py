        ...
        try:
            ...
            with conn.cursor() as cursor:
                query = """
                        ...
                        WHERE staff_id = %s
                    """
                print(f"Executing query with staff_id={staff_id}")  # Debug log
                cursor.execute(query, (staff_id,))
                result = cursor.fetchone()

                if not result:
                    print(f"No staff found for staff_id={staff_id}")  # Debug log
                    return None
                ...
                print(f"Fetched staff details: {result}")  # Debug log
                print (result)
